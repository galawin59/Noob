    ...
    public class TMP_TextSelector_B : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerClickHandler, IPointerUpHandler
    {
        ...
        void LateUpdate()
        {
            if (isHoveringObject)
            {
                ...
                if (charIndex != -1 && charIndex != m_lastIndex && (InputManager.GetInputManager.GetKey(KeyCode.LeftShift) || InputManager.GetInputManager.GetKey(KeyCode.RightShift)))
                {
                ...
                if (wordIndex != -1 && wordIndex != m_selectedWord && !(InputManager.GetInputManager.GetKey(KeyCode.LeftShift) || InputManager.GetInputManager.GetKey(KeyCode.RightShift)))
                {
